...
for (file_id in 1:1){
  ...
  p <- ggplot() +
          ...
          geom_point(data = oth_coord_2, aes(x = X, y = Y), alpha = 0.1) +
          theme_bw() +
          theme(aspect.ratio = 1) +
          ggtitle("Distribution of Foxa1 expression in B cell-Immature") +
          xlab("X coordinate") +
          ylab("Y coordinate")

  pdf(paste0(my_working_dir, "/results_CCPLS/Foxa1_orig.pdf"))
  plot(p)
  dev.off()
