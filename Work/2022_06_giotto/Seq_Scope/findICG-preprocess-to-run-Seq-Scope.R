...
dataset_Seq_Scope <- list(
  working_dir = "~/CCPLS_paper/Work/2022_06_giotto/Seq_Scope",
  exp_file_all = c("exp_mat_Seq_Scope.tsv"),
  coord_file_all = c("coord_mat_Seq_Scope.tsv"),
  annot_file_all = c("annot_mat_Seq_Scope.tsv"),
  rdata_path = "Seq_Scope_result.Rdata",
  rdata_path2 = "Seq_Scope_result_2.Rdata",
  tsv_prefix = "Seq_Scope",
  data_flag = "Seq_Scope"
)