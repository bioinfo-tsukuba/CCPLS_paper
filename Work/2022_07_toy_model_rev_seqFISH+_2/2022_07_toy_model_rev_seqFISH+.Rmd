...
## Prepare
rm(list = ls())
setwd("~/CCPLS_paper/Work/2022_07_toy_model_rev_seqFISH+_2")
```


```{r}
# Reading files
my_working_dir <- "~/CCPLS_paper/Work/2022_07_toy_model_rev_seqFISH+_2"
...
write.table(coord_mat_seqFISHplus[annot_mat_seqFISHplus[,3] == "L5 eNeuron",],
            "~/CCPLS_paper/Work/2022_07_toy_model_rev_seqFISH+_2/simulated_data_rev/coord_mat.tsv",
            sep = "\t",
            row.names = FALSE)
...
# save annot_mat
write.table(annot_mat_toy, file = "~/CCPLS_paper/Work/2022_07_toy_model_rev_seqFISH+_2/simulated_data_rev/annot_mat_toy.tsv",
sep = "\t",
row.names = FALSE)

# save coord_mat
write.table(coord_mat_seqFISHplus, file = "~/CCPLS_paper/Work/2022_07_toy_model_rev_seqFISH+_2/simulated_data_rev/coord_mat_toy.tsv",
sep = "\t",
row.names = FALSE)
...
output_exp_name <- paste0("~/CCPLS_paper/Work/2022_07_toy_model_rev_seqFISH+_2/seqFISH+_real_data/exp_mat_all.tsv") 
output_coord_name <- paste0("~/CCPLS_paper/Work/2022_07_toy_model_rev_seqFISH+_2/seqFISH+_real_data/coord_mat_all.tsv") 
output_annot_name <- paste0("~/CCPLS_paper/Work/2022_07_toy_model_rev_seqFISH+_2/seqFISH+_real_data/annot_mat_all.tsv") 
...
# Save
save.image("~/CCPLS_Paper/Work/2022_07_toy_model_rev_seqFISH+_2/results_collect/res.list.RData")
```
...
for (exp_id_pre in 1:length(exp_id_list)){
  ...
  if (exp_id == 1){
    pcc_all_vec <- append(pcc_all_vec, 0)
    ari_vec <- append(ari_vec, 0)
    prec_srg1_vec <- append(prec_srg1_vec, 0)
    prec_srg2_vec <- append(prec_srg2_vec, 0)
    prec_srg3_vec <- append(prec_srg3_vec, 0)
    prec_non_srg_vec <- append(prec_non_srg_vec, 0)
    rec_srg1_vec <- append(rec_srg1_vec, 0)
    rec_srg2_vec <- append(rec_srg2_vec, 0)
    rec_srg3_vec <- append(rec_srg3_vec, 0)
    rec_non_srg_vec <- append(rec_non_srg_vec, 0)
  
    var_prop_mean_vec <- append(var_prop_mean_vec, 0.00886370563374601)
  }
