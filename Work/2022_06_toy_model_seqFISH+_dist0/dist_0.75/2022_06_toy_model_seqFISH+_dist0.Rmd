...
## Prepare
rm(list = ls())
setwd("~/CCPLS_paper/Work/2022_06_toy_model_seqFISH+_dist0/dist_0.75")
```


```{r}
# Reading files
my_working_dir <- "~/CCPLS_paper/Work/2022_06_toy_model_seqFISH+_dist0/dist_0.75"
...
write.table(coord_mat_seqFISHplus[annot_mat_seqFISHplus[,3] == "L5 eNeuron",],
            "~/CCPLS_paper/Work/2022_06_toy_model_seqFISH+_dist0/dist_0.75/simulated_data_5/coord_mat.tsv",
            sep = "\t",
            row.names = FALSE)
...
# save annot_mat
write.table(annot_mat_toy, file = "~/CCPLS_paper/Work/2022_06_toy_model_seqFISH+_dist0/dist_0.75/simulated_data_5/annot_mat_toy.tsv",
sep = "\t",
row.names = FALSE)

# save coord_mat
write.table(coord_mat_seqFISHplus, file = "~/CCPLS_paper/Work/2022_06_toy_model_seqFISH+_dist0/dist_0.75/simulated_data_5/coord_mat_toy.tsv",
sep = "\t",
row.names = FALSE)
...
output_exp_name <- paste0("~/CCPLS_paper/Work/2022_06_toy_model_seqFISH+_dist0/dist_0.75/seqFISH+_real_data/exp_mat_all.tsv") 
output_coord_name <- paste0("~/CCPLS_paper/Work/2022_06_toy_model_seqFISH+_dist0/dist_0.75/seqFISH+_real_data/coord_mat_all.tsv") 
output_annot_name <- paste0("~/CCPLS_paper/Work/2022_06_toy_model_seqFISH+_dist0/dist_0.75/seqFISH+_real_data/annot_mat_all.tsv") 
...
for (ct_ind in 1:length(ct_list)){
  ...
  output_exp_name <- paste0("~/CCPLS_paper/Work/2022_06_toy_model_seqFISH+_dist0/dist_0.75/seqFISH+_real_data/exp_mat_", ct_ind, ".tsv") 
  
  output_coord_name <- paste0("~/CCPLS_paper/Work/2022_06_toy_model_seqFISH+_dist0/dist_0.75/seqFISH+_real_data/coord_mat_", ct_ind, ".tsv") 
  
  output_annot_name <- paste0("~/CCPLS_paper/Work/2022_06_toy_model_seqFISH+_dist0/dist_0.75/seqFISH+_real_data/annot_mat_", ct_ind, ".tsv") 
...
# Save
save.image("~/CCPLS_Paper/Work/2022_06_toy_model_seqFISH+_dist0/dist_0.75/results_collect/res.list.RData")
saveRDS(res.list, "~/CCPLS_Paper/Work/2022_06_toy_model_seqFISH+_dist0/dist_0.75/results_collect/res.list.rds")
